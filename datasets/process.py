...
def get_calpha_graph(name, rec, state1, c_alpha_coords, n_coords, c_coords, chis, chi_masks, structure_graph, cutoff=20, max_neighbor=None, lm_embeddings=None):
...
def get_rec_graph(name, rec, state1, rec_coords, c_alpha_coords, n_coords, c_coords, chis, chi_masks, structure_graph, rec_radius, c_alpha_max_neighbors=None, all_atoms=False,
    ...
    if all_atoms:
        ...
        return get_calpha_graph(name, rec, state1, c_alpha_coords, n_coords, c_coords, chis, chi_masks, structure_graph, rec_radius, c_alpha_max_neighbors, lm_embeddings=lm_embeddings)
